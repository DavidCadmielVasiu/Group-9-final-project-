This folder contains the application files that you can run to start the project/ application. 
**Instructions
...
3. Import any needed dependencies:
 ...
 5. Run the AlcoholAbuseApp.py file. On the top menu in PyCharm click "Run", and select "Run 'AlcoholAbuseApp'".
 6. Once the app is running, open the link in the bottom pane of PyCharm. The panel should have the following, "Dash is running on <http://"ip address with port">/", click on the ip address and it should open the application in a browser. 
